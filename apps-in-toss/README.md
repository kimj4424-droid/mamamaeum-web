...
1. `apps-in-toss.config.ts`의 `appName: 'momslator'`을 앱인토스 콘솔의 실제 appName과 일치시킵니다.
...
4. Vercel API에는 `momslator.apps.tossmini.com`과 `momslator.private-apps.tossmini.com`만 허용됩니다. QR 샌드박스에서 실제 AI 호출을 테스트합니다.
